...
ggplot(data = tmp_plot_new[br %in% c("116","153",
                                     "277","369",
                                     "376","476")]) +
...
ggsave("figures/sinistros_bicicleta.png",
...
ggplot(data = tmp_plot[br %in% c("116","153",
                                 "277","369",
                                 "376","476")]) +
...
ggsave("figures/colisoes_totais_por_vitima.png",
       scale = 1,width = 23.5,height = 13,dpi = 300, units = "cm")
###
...
ggsave("figures/colisoes_fatais_por_vitima.png",
       scale = 1,width = 23.5,height = 13,dpi = 300, units = "cm")
